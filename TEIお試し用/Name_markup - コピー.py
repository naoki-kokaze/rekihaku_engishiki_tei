...
def main():
    ...
    # 新しい保存先ディレクトリの設定
    save_dir = r"C:\Users\engishiki23\Desktop\python練習用\20250217"
    if not os.path.exists(save_dir):
        os.makedirs(save_dir)  # 必要ならディレクトリを作成

    # 新しいファイルパスの生成（入力ファイル名に "_Name" を追加）
    intermediate_xml_path = os.path.join(save_dir, f"{base_name}_Name.xml")
